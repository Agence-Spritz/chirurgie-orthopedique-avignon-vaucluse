		...
		<nav class="navbar navbar-default">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      <ul class="nav navbar-nav">
		        ...
		        <li <?php  if (strpos($url,'diapo.php') !== false) { echo 'class="active"'; } ?> ><a href="diapo.php">Diaporama </a></li>
		        <li <?php  if (strpos($url,'equipe.php') !== false) { echo 'class="active"'; } ?> ><a href="equipe.php">Membre de l'équipe </a></li>
		        <li class="dropdown">
