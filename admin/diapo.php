					...
					<form method="post" action="" enctype="multipart/form-data">
					    ...
					    <input type="hidden" name="rub" value="<?=$rub?>">
							...
							<div class="col-sm-12 col-md-6">
							        ...
							        <h4><i class='fa fa-pencil-square-o '></i> Lien de la diapo (en savoir +)</h4>
							        <div class="form-group">
