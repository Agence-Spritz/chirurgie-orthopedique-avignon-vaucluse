...
$chemin = "../images/pages-chirurgie-genou-hanche-orthopedie-84-vaucluse-avignon/";  							// "/" à la fin
							...
							<div class="col-sm-12 col-md-6">
							        ...
							        <div class="form-group">   
							          	<select name="<?=$chps[8]?>" class="form-control">
								          	<option value="1" <?php if($$chps[8]==1) {echo "selected";}  ?>>Modèle 1 (couverture claire, image 1/texte 1, galerie, séparateurs )</option>
								          	<option value="2" <?php if($$chps[8]==2) {echo "selected";}  ?>>Modèle 2 (couverture foncée, textes sans image, galerie)</option>
								          	<option value="3" <?php if($$chps[8]==3) {echo "selected";}  ?>>Modèle 3 (couverture foncée + 1 image/section)</option>
										</select>
							        </div>
